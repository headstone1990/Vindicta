...
_array set [T_NAME, "tBAF_desert"]; // 														Template name + variable (not displayed)
_array set [T_DESCRIPTION, "BAF_desert"]; // 			Template display description
_array set [T_DISPLAY_NAME, "BAF_desert"]; // 											Template display name
...
_inf set [T_INF_default,  ["C_man_1"]];					//Default infantry if nothing is found

_inf set [T_INF_SL, ["BAF_Rifleman_d"]]; // = 1
_inf set [T_INF_TL, ["BAF_Rifleman_d"]]; // = 2
_inf set [T_INF_officer, ["BAF_Rifleman_d"]]; // = 3
_inf set [T_INF_GL, ["BAF_Rifleman_d"]]; // = 4
_inf set [T_INF_rifleman, ["BAF_Rifleman_d"]]; // = 5
_inf set [T_INF_marksman, ["BAF_Rifleman_d"]]; // = 6
_inf set [T_INF_sniper, ["BAF_Rifleman_d"]]; // = 7
_inf set [T_INF_spotter, ["BAF_Rifleman_d"]]; // = 8
_inf set [T_INF_exp, ["BAF_Rifleman_d"]]; // = 9
_inf set [T_INF_ammo, ["BAF_Rifleman_d"]]; // = 10
_inf set [T_INF_LAT, ["BAF_Rifleman_d"]]; // = 11
_inf set [T_INF_AT, ["BAF_Rifleman_d"]]; // = 12
_inf set [T_INF_AA, ["BAF_AA_d"]]; // = 13
_inf set [T_INF_LMG, ["BAF_AA_d"]]; // = 14
_inf set [T_INF_HMG, ["BAF_AA_d"]]; // = 15
_inf set [T_INF_medic, ["BAF_AA_d"]]; // = 16
_inf set [T_INF_engineer, ["BAF_AA_d"]]; // = 17 
_inf set [T_INF_crew, ["BAF_AA_d"]]; // = 18
_inf set [T_INF_crew_heli, ["BAF_AA_d"]]; // = 19
_inf set [T_INF_pilot, ["BAF_AA_d"]]; // = 20
_inf set [T_INF_pilot_heli, ["BAF_AA_d"]]; // = 21
_inf set [T_INF_survivor, ["BAF_AA_d"]]; // = 22
_inf set [T_INF_unarmed, ["BAF_AA_d"]]; // = 23
/* Recon unit classes */
_inf set [T_INF_recon_TL, ["BAF_AA_d"]]; // = 24
_inf set [T_INF_recon_rifleman, ["BAF_AA_d"]]; // = 25
_inf set [T_INF_recon_medic, ["BAF_AA_d"]]; // = 26
_inf set [T_INF_recon_exp, ["BAF_AA_d"]]; // = 27
_inf set [T_INF_recon_LAT, ["BAF_AA_d"]]; // = 28
_inf set [T_INF_recon_marksman, ["BAF_AA_d"]]; // = 29
_inf set [T_INF_recon_JTAC, ["BAF_AA_d"]]; // = 30
/* Diver unit classes */
_inf set [T_INF_diver_TL, ["BAF_AA_d"]]; // = 31
_inf set [T_INF_diver_rifleman, ["BAF_AA_d"]]; // = 32
_inf set [T_INF_diver_exp, ["BAF_AA_d"]]; // = 33
